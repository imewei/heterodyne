...
# Heterodyne Documentation

import os
import sys
from pathlib import Path

# Add the parent directory (containing heterodyne package) to the Python path
...
try:
    from heterodyne import __version__ as _pkg_version
...
# Project metadata
project_description = (
    "CPU-optimized JAX-based heterodyne scattering analysis for XPCS "
...
html_theme_options = {
    ...
    "light_css_variables": {
        # Primary brand — deeper blue-violet for heterodyne identity
        ...
        "--color-admonition-background-note": "#E8EAF6",
        "--color-admonition-title-note": "#283593",
        # Typography
        "--font-stack": (
    ...
    "dark_css_variables": {
        ...
        "--color-admonition-background-note": "#1A1A3E",
        "--color-admonition-title-note": "#7986CB",
        # Typography
        "--font-stack": (
            "Inter, -apple-system, BlinkMacSystemFont, "
            "Segoe UI, Helvetica Neue, Arial, sans-serif"
...
\makeatother
\sloppy
% Suppress persistent page-oscillation warning in large documents
\usepackage{silence}
...
man_pages = [("index", "heterodyne", "Heterodyne Documentation", [author], 1)]
...
linkcheck_ignore = [
    ...
    r"https://github\.com/imewei/heterodyne.*",  # Private repository (404)
]
